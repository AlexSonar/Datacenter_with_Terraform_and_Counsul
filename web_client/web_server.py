...
####################
"""
Takes a port number and returns True if it's available for the web server to use; 
False otherwise.
"""
...
with socketserver.TCPServer(("", port), Handler) as httpd:
    try:
        ...
        print("Failed to connect to Consul... make sure you have an agent running?")
        sys.exit(1)
